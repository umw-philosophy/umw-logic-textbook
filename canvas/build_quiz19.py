#!/usr/bin/env python3
"""Build a Canvas Common Cartridge (.imscc) package for Quiz 19: All 18 Natural Deduction Rules."""
...
CANVAS = ROOT / "canvas"
BUILD = CANVAS / "build_quiz19_temp"
IMSCC_TARGET = CANVAS / "quiz19_all_rules.imscc"
...
QUIZ = {
    "slug": "quiz19_all_rules",
    "title": "Quiz 19: All 18 Natural Deduction Rules",
    "description": "Autograded multiple-choice quiz testing both implication and replacement rules (18 rules total).",
    "questions": [
        # Question 1
        (
            "<p>Given the following natural deduction proof, what is a valid next line using the 18 rules of natural deduction?</p>"
            '<table border="0" cellpadding="3" style="font-family: monospace; font-size: 1.1em;">'
            "<tr><td>1.</td><td>P ∨ (Q · R)</td><td></td></tr>"
            "</table>",
            [
                "2. (Q · R) ∨ P &nbsp;&nbsp;&nbsp;&nbsp; 1 Com",
                "2. (P ∨ Q) · R &nbsp;&nbsp;&nbsp;&nbsp; 1 Assoc",
        ...
        (
            ...
            '<table border="0" cellpadding="3" style="font-family: monospace; font-size: 1.1em;">'
            "<tr><td>1.</td><td>~(A · B)</td><td></td></tr>"
            "<tr><td>2.</td><td>C ⊃ (A · B)</td><td>/ ~C</td></tr>"
            "</table>",
            [
                "3. ~C &nbsp;&nbsp;&nbsp;&nbsp; 2,1 MT",
                "3. ~A · ~B &nbsp;&nbsp;&nbsp;&nbsp; 1 DeM",
        ...
        (
            "<p>Given the following natural deduction proof, what is a valid next line using the 18 rules of natural deduction?</p>"
            '<table border="0" cellpadding="3" style="font-family: monospace; font-size: 1.1em;">'
            "<tr><td>1.</td><td>(P ∨ P) ⊃ Q</td><td></td></tr>"
            "</table>",
            [
                "2. P ⊃ Q &nbsp;&nbsp;&nbsp;&nbsp; 1 Taut",
                "2. (P ∨ P) ∨ ~Q &nbsp;&nbsp;&nbsp;&nbsp; 1 Impl",
...
def qti_for_quiz(quiz: dict) -> str:
    ...
    for q_idx, (prompt, choices, correct) in enumerate(quiz["questions"], start=1):
        ...
        for c_idx, choice in enumerate(choices):
            ident = f"q19_{q_idx}_a{c_idx}"
            choice_xml.append(f"""
              <response_label ident="{ident}">
                <material><mattext texttype="text/html">{html.escape(choice)}</mattext></material>
              </response_label>""")
        correct_ident = f"q19_{q_idx}_a{correct}"
        items.append(f"""
      <item ident="q19_{q_idx}" title="Question {q_idx}">
        <itemmetadata>
          <qtimetadata>
  ...
  <organizations>
    <organization identifier="{uid('org')}" structure="rooted-hierarchy">
      <item identifier="{uid('module')}">
        <title>Chapter 11 Quizzes</title>
{items}
      </item>
    </organization>
  </organizations>
